...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/ShaohongDong/sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="ShaohongDong/sub2api"
...
Documentation=https://github.com/ShaohongDong/sub2api
