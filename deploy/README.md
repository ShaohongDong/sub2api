...
All release downloads, update checks, and deployment scripts here are aligned with the canonical repository `ShaohongDong/sub2api`.
...
curl -sSL https://raw.githubusercontent.com/ShaohongDong/sub2api/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
curl -sSL https://raw.githubusercontent.com/ShaohongDong/sub2api/main/deploy/install-deps.sh | sudo bash
...
1. Download the latest release from [GitHub Releases](https://github.com/ShaohongDong/sub2api/releases)
